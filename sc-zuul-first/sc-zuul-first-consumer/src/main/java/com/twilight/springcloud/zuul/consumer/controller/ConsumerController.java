package com.twilight.springcloud.zuul.consumer.controller;

import com.twilight.springcloud.zuul.consumer.model.OrderModel;
...
public class ConsumerController {
    ...
    public OrderModel getOrderInfo(@PathVariable Long id) {
        return this.restTemplate.getForObject("http://provider1/" + "/sc/order/" + id, OrderModel.class);
    }
